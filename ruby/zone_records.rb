...
# Usage: zone_records.rb example.com
...
# Dnsimple::Client::Domains#list_records is the method to list the records in a DNSimple zone.
response = client.zones.list_records(account_id, ARGV.last)
