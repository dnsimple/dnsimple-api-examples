...
# ./domain_transfers.rb testing.com 42
...
puts "Getting transfer #{transfer_id} for domain #{name}"

# Dnsimple::Client::Registrar#get_domain_transfer is the method for retrieving a domain transfer.
response = client.registrar.get_domain_transfer(account_id, name, transfer_id)
